...
extern void hw_dma(byte b);
extern void hw_hdma();
extern void hw_hdma_cmd(byte c);
extern void pad_refresh();
extern void pad_press(byte k);
extern void pad_release(byte k);
extern void pad_set(byte k, int st);
